...
import { MESSAGE_QUERY, SEND_MESSAGE_MUTATION } from './message.graphql';
...
export class Message extends Component {
  state = {
    recipients:
      (this.props.recipients && this.props.recipients.split(',')) || [],
    subject: '',
    htmlText: '',
  };
                  ...
                  return (
                    <>
                      ...
                      <Select
                        ...
                        options={[
                          ...this.determineEmailGroups(
                            myself.role,
                            myself.accountStatus,
                          ),
          ...
          >
            {(sendMessage, { data = {}, loading, error }) => (
              <>
                ...
                {data.sendMessage && <p>{data.sendMessage.message}</p>}
